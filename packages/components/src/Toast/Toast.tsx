 ...
 * outcome of an action. Intended to be placed bottom-right of the screen and to
 * persist ~7s (set `duration`); positioning/stacking is owned by the consumer's
 * toast container, this component is the visual surface. Figma `68:36772`.
 */
export const Toast = React.forwardRef<HTMLDivElement, ToastProps>(function Toast(
  ...
  return (
    <div ref={ref} role="status" aria-live="polite" style={rootStyle} {...rest}>
